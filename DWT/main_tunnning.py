...
def process(params):
    eps, B, d_max, l_start, labels, tolerance = params
    results = []
...
if __name__ == '__main__':
    ...
    params_with_data = [(eps, B, d_max, l_start, labels, tolerance) for eps, B, d_max, l_start in param_combinations]
    ...
    print(f"/n Best F1 Score: {best_result['f1']:.4f}")
    print(f"Parameters: eps={best_result['eps']:.4f}, B={best_result['B']}, d_max={best_result['d_max']}, l_start={best_result['l_start']}")
